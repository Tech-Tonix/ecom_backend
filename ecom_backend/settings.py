...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "GymRAT",
    "site_brand": "GymRAT",
    # "site_icon": "admin/img/rat.png",
    # Add your own branding here
    # "site_logo": "img/rat.png",
    ...
    "hide_apps": ["AuthToken","PythonSocialAuth","Account","AuthenticationAndAuthorization","token_blacklist",
                          "social_django", "socialaccount","auth",],

    "icons": {
        "Core": "fas fa-users-cog",
        "Core.Customuser": "fas fa-user",
        "Favorites.Favoritesitem":"fas fa-heart",
        "Reviews.review":"fas fa-star",
        "Store.product":"fas fa-tag",
        "Store.order":"fas fa-box",
        "Store.cartitem":"fas fa-shopping-bag",
        "Store.Archivedorder":"fas fa-archive",
        "Store.Archivedorderitems":"fas fa-history",
